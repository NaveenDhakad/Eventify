...
<body>
      ...
      <%@include file = "afterloginnav.jsp"%>
            ...
            <%@include file = "createbuttonpopup.jsp"%>
                ...
                <div class="empty-state">
                    ...
                    <h4>Create Event</h4>
                    <p class="text-muted">You haven't created any events yet, but you're in the right place to start!</p>
                    <button class="btn create-event-btn text-white"> Create Event</button>
  ...
  <%@include file = "leftpopupmyaccount.jsp"%></body>
</html>